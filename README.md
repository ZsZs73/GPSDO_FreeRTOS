...
dac_ext.cpp             external SPI DAC: AD5680 (18-bit), bit-banged
gpsdo_pwm24.cpp         24-bit control voltage from dithered PWM (on-board path)
...
tools/                  harnesses and analysers: loopsim, hostcheck,
                        innovation_check.py, episode_r.py, thermcheck.py
